...
export function getClassificationFromAverage(percent) {
  if (percent == null || isNaN(percent)) return 'Bronze';
...
export function classificationFromScores(scores, opts = {}) {
  ...
  const tier = classificationFromAvg(avgPts, avgX);
